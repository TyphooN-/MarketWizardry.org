...
IMPROVED_FLAVOR_TEXT = {
    ...
    "natived_": "natived_'s digital art collection - Native perspectives in the digital realm. This artist brings cultural depth to blockchain art, blending traditional influences with modern digital expression.",
...
def update_gallery_flavor_text(artist_name, new_flavor_text):
    ...
    # Find and replace the flavor text
    import re
    pattern = r'(<div class="flavor-text">)(.*?)(</div>)'
    replacement = r'\1' + new_flavor_text + r'\3'
...
def main():
    """Update all gallery flavor text to be more respectful"""
