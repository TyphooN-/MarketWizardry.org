...
The win rate flipped from 33.60% to 34.43%. ATPK now wins more often than it loses. The tradeoff: the W/L ratio inverted from 2.08x to 0.85x. Old ATPK won rarely but won big. New ATPK wins constantly but loses more per loss. The math works out better — $179.87 per trade versus $7.29.
...
ATPK is the Monty Python Black Knight of DARWINs. You cut off its arm (-$38K month), it says "tis but a scratch." You cut off its other arm (-$29K month), it says "come back here, I'll bite your legs off." You reduce it to a torso with a 21% drawdown and it grows its arms back and starts swinging at $179.87 per trade.
...
### 2. Quick Exits
Average loss: $716.68. Bigger than before ($234.10 in the zombie days), but ATPK now wins 34.43% of the time and makes $610.43 per win. The W/L ratio inverted — wins more often, loses more per loss — but the expected payoff jumped from $7.29 to $179.87. The zombie traded its shield for a sword and the math works.
...
> **DISCLAIMER:** This post describes trading results from a Darwinex Zero account with virtual capital. This is NOT financial advice. Past performance does not guarantee future results. Making $179.87 per trade is better than $7.29 but still not a retirement plan. Do not trade stocks with money you cannot afford to lose. The author operates multiple DARWINs on Darwinex.
