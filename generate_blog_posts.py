...
{json_ld_schema}
    ...
    <script defer data-domain="marketwizardry.org" src="/js/plausible.js"></script>
</head>
<body>
<div class="container">
...
def generate_witty_description(content, filename, title):
    ...
    darwin_graveyard_unique = {
        ...
        'oams': "Here lies OAMS — Ounces Are My Specialty. Dark City couldn't save it. XAGUSD at $36K/lot — same disease, different metal. PROTECT fired, broker finished the job. Five hedged MG DARWINs dead. The experiment is over.",
...
def generate_flavor_text(title, filename):
    ...
    if 'buls' in filename_lower and ('benchmark' in filename_lower or 'buls' in filename_lower.split('-')):
        return "Here lies BULS — Benchmark Underway Lot Simulation. The chosen DARWIN. The last hedged martingale standing. The broker stepped in. You can't outsmart the broker with hedged martingale."
